    ...
    > 
      <div className={styles.modalHeader}>
        <div className={styles.iconBox}>
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-x" width="80" height="80" viewBox="0 0 24 24" stroke-width="1.5" stroke="#F15E5E" fill="" stroke-linecap="round" stroke-linejoin="round" >
